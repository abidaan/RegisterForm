...
setTimeout(function(){
	//Setting the monitoring period to the last five minutes.
	...
	//The data to be sent to New Relic to retrieve the average response time (avgRT) of the application(s) that is(are) being monitored
